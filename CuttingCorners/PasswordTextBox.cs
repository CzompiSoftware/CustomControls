...
{
    public class PasswordTextBox : System.Windows.Controls.TextBox
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(PasswordTextBox), new UIPropertyMetadata(8.0, DogEarPropertyChanged));

        private static void DogEarPropertyChanged(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs e)
        {
            ((PasswordTextBox)obj).InvalidateVisual();
        }
        #endregion
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(PasswordTextBox), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(PasswordTextBox), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
        ...
        {
            SizeChanged += new SizeChangedEventHandler(PasswordTextBox_SizeChanged);
        }

        void PasswordTextBox_SizeChanged(object sender, SizeChangedEventArgs e)
        {
