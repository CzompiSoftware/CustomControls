...
namespace hu.czompisoftware.customcontrols.CuttingCorners
{
    public class TabItem : System.Windows.Controls.TabItem
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(TabItem), new UIPropertyMetadata(8.0, DogEarPropertyChanged));

        private static void DogEarPropertyChanged(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs e)
        {
            ((TabItem)obj).InvalidateVisual();
        }
        #endregion
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(TabItem), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(TabItem), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
        ...
        public TabItem()
        {
            this.SizeChanged += new SizeChangedEventHandler(TabItem_SizeChanged);
        }

        void TabItem_SizeChanged(object sender, SizeChangedEventArgs e)
        {
