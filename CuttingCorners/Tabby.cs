...
namespace hu.czompisoftware.customcontrols.CuttingCorners
{
    public class Tabby : HeaderedContentControl
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(Tabby), new UIPropertyMetadata(8.0, DogEarPropertyChanged));
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(Tabby), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(Tabby), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
