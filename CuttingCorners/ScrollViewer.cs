...
namespace hu.czompisoftware.customcontrols.CuttingCorners
{
    public class ScrollViewer : System.Windows.Controls.ScrollViewer
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(ScrollViewer), new UIPropertyMetadata(8.0, DogEarPropertyChanged));

        private static void DogEarPropertyChanged(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs e)
        {
            ((ScrollViewer)obj).InvalidateVisual();
        }
        #endregion
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(ScrollViewer), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(ScrollViewer), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
        ...
        public ScrollViewer()
        {
            this.SizeChanged += new SizeChangedEventHandler(ScrollViewer_SizeChanged);
        }
