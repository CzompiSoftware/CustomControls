...
namespace hu.czompisoftware.customcontrols.CuttingCorners
{
    public class ListBox : System.Windows.Controls.ListBox
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(ListBox), new UIPropertyMetadata(8.0, DogEarPropertyChanged));

        private static void DogEarPropertyChanged(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs e)
        {
            ((ListBox)obj).InvalidateVisual();
        }
        #endregion
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(ListBox), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(ListBox), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
        ...
        public ListBox()
        {
            this.SizeChanged += new SizeChangedEventHandler(ListBox_SizeChanged);
        }
