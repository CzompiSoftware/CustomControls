...
namespace hu.czompisoftware.customcontrols.CuttingCorners
{
    public class Button : System.Windows.Controls.Button
    {
        ...
        public static readonly DependencyProperty DogEarProperty = DependencyProperty.Register("DogEar", typeof(double), typeof(Button), new UIPropertyMetadata(8.0, DogEarPropertyChanged));

        private static void DogEarPropertyChanged(
            DependencyObject obj,
            DependencyPropertyChangedEventArgs e)
        {
            ((Button)obj).InvalidateVisual();
        }
        #endregion
        ...
        public static readonly DependencyProperty IsMirroredDogEarProperty = DependencyProperty.Register("IsMirroredDogEar", typeof(Boolean), typeof(Button), new UIPropertyMetadata(false, IsMirroredDogEarPropertyChanged));
        ...
        public static readonly DependencyProperty MergeSideProperty = DependencyProperty.Register("MergeSide", typeof(MergeSideObject), typeof(Button), new UIPropertyMetadata(default(MergeSideObject), MergeSidePropertyChanged));
        ...
        public Button()
        {
            this.SizeChanged += new SizeChangedEventHandler(Button_SizeChanged);
        }
